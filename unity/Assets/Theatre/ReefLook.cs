...
namespace Evosim.Theatre
{
    ...
    public readonly struct ReefLook
    {
        ...
        public static ReefLook From(ReefGeometry reefs, int i)
        {
            ...
            // ----------------------------------------------------------------------------------
            float capRadius = reefs.CapRadiusMetres;
            Func<float, float> outline = theta => capRadius;
            float capTop = (float)reefs.CapTopY;
            float underside = (float)reefs.CapUndersideY;
            float stem = reefs.StemRadiusMetres;
            int seed = SeedOf(i, x, z);
            // ==================================================================================

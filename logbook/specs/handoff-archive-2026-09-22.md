# Handoff notes archived on 2026-09-22

*The dated notes and the queue that HANDOFF.md carried from its 2026-09-13 rewrite to the
2026-09-22 one, moved here whole when the file was rewritten. The logbook entries 0096 to
0110 and the specs beside them are the record; this is the working log those entries were
written from, kept so that nothing said in it is lost.*

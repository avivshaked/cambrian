...
ended with 318. That is fewer than the thousand I expected when I pre-registered the pair,
so the long confirmation is a long one rather than a big one. The population it did carry was in

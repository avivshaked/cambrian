# 0076 — The hole refills in five seconds

**2026-09-08**  ·  why round 30's swimmers found no prize, measured in Core while the round ran

Round 30 (logbook/0075) was two thirds through when the owner asked whether we were getting
swimmers. We were not: no arm held an inherited jointed body, and the one line that had
lasted, fourteen bodies in seed 4 for the first 10,000 s, had died out. The owner offered a
hypothesis in one line. The field has too few vertices, so a moving body and a sitting one
do not see materially different water, and a sitter that ought to deplete its water does
not. That is a claim about the field, and the field can be asked directly, without Unity
and without waiting for the round.

## What the arms already said
...
|---|---|---|---|
| 0.2 | 0.03 | 0.95 to 1.05 | 0.4 to 0.8 |
| 0.2 | 0.3 | 1.05 to 1.11 | 0.4 to 0.8 |
...
remineralisation off and on. I had predicted the larder would move to the deep at low
mixing, from a scale height of D over the sink speed, and the experiment says the opposite.

| mixing | in the top 20 m | mean depth | on the floor |
|---|---|---|---|
| 0.2 | 56% | 20.7 m | 0% |
| 0.02 | 86% | 12.2 m | 0% |

Less stirring keeps the food where it was made, and the sink moves it only 6 m in 3,000 s.
Remineralisation changed nothing at either rate because nothing reached the floor to be
lifted; round 30's arms hold 0.1 to 0.5% of their detritus on the floor at 20,000 s. The
scale-height argument describes a steady state the world never reaches inside a run.

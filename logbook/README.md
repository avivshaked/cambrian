...
| [0114](0114-the-mouth.md) | 2026-09-22 | The mouth (round 45, D106's second rung, three seeds, pre-registered: whether a scavenger founds, whether a killer founds, whether a plant that regrows survives grazing, whether defence follows offence, the crowd, the books, and the yield as the reserve) on the island world (D108, D109: the tank ten times round 44's, 15,000 units seeded as noise islands in the top 12 m with the founders planted in them, the matter grid stirred at the snow's rate; J8 to J10 read the islands, and the screen's maps are the entry's pictures) |

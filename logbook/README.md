...
| [0104](0104-the-theatre-gets-its-second-look.md) | 2026-09-16 | The theatre gets its second look (the look's design pass built in one day: linear colour, the post stack, the lit top water, the guild through backlit tissue, the skin genes theatre-only; six renders of one second, what each found) |
| [0105](0105-the-shelf-was-never-in-the-light.md) | 2026-09-18 | The shelf was never in the light (round 39 read: the bed's shelf sat below the leaves' band, the pockets were not there, the eaters boomed and starved again; the first pictures of a full-length seed) |
| [0106](0106-the-light-stops-at-ten-metres.md) | 2026-09-18 | The light stops at ten metres (round 40, round 39's world with the light's reach halved to 6 m, pre-registered: the leaves' band, the shading in it, the dark column under it) |
| [0109](0109-the-water-held-and-the-bush-refused.md) | 2026-09-20 | The water held, and the bush refused (round 41e, round 41d's world with D100's held water and D101's birth rule against a body folded on itself, pre-registered: 0108's predictions carried, the refusal share and the shape of what selection grows added; **stopped at 10,000 to 17,000 s for a reboot the agent's orphaned watch loops forced, and read as it stands:** the fold gone (0.06 to 0.22 pairs a body against 41d's 1.3 to 3.0), nothing thrown in 16 M jointed body-seconds, bodies of two and three parts spreading, the pace still failing in the jointed seeds, the eaters founded in one seed of three) |
| [0110](0110-half-the-matter.md) | 2026-09-20 | Half the matter (round 42, round 41e's world on 1,500 units, on the build with the solver read shared and the trace for jointed bodies only, each arm pinned to fast cores of its own, pre-registered: the crowd halves, the mechanism readings stay, a seed runs near real time, and 41e's unread 30,000 s clauses are asked again; the raised bed waits on the owner, since the streams refuse a tank that flat) |
| [0111](0111-the-same-world-on-the-new-engine.md) | 2026-09-22 | The same world on the new engine (round 43, round 42's world on the farm out of Unity with the water sampled per link, three seeds, pre-registered: the crowd, the treadmill, the larder and the spread as round 42's, the eaters at zero, and whether joints fade once a body's own parts no longer jam them) |
| [0112](0112-one-thread-a-creature.md) | 2026-09-22 | One thread a creature (the GPU spike: the per-creature step as an ILGPU kernel, exact against the library, bit-identical across launch shapes; double slower than sixteen cores, single six times faster at 1.4 mm in ten seconds, the card idle until 30,000 bodies, and the precision put to the owner) |
| [0113](0113-the-part-made-by-a-rule.md) | 2026-09-22 | The part made by a rule (round 44, the module gene of D106 on round 43's world over the double accounts, three seeds, pre-registered: whether the gene appears and is kept, whether plants keep it more than jointed bodies, whether an indeterminate body's size tracks its reserve, and the economy and the books as round 43's. Read: the gene is kept in two seeds of three and nearly the third, jointed bodies keep it as readily as leaves, the rule is refused hundreds of times per add, the books close to 1e-06 units, and seed 1's world of module chains went deep and to the glass and slowed the solver sevenfold per body-step before ending on a centre-of-mass guard) |
| [0114](0114-the-mouth.md) | 2026-09-22 | The mouth (round 45, D106's second rung, three seeds, pre-registered: whether a scavenger founds, whether a killer founds, whether a plant that regrows survives grazing, whether defence follows offence, the crowd, the books, and the yield as the reserve) on the island world (D108, D109: the tank ten times round 44's, 15,000 units seeded as noise islands in the top 12 m with the founders planted in them, the matter grid stirred at the snow's rate; J8 to J10 read the islands, and the screen's maps are the entry's pictures). Read 2026-09-23: the mouth works and nobody uses it; every consumer founder died childless in a world empty of its food at the start, seed 3 grew one late jointed killer clade accelerating when the round ended, the snow follows the crowd and the stirring flattens it |
| [0115](0115-the-crowd-on-the-card.md) | 2026-09-23 | The crowd on the card (GPU spike 3: the contact kernel and the brain-and-senses kernel transcribed and proved bit-exact in double against the library over 1,000 steps of round 45's crowd, then timed in single on the 4090: 2.6x to 8.2x and 1.3x to 7.5x over 16 threads at 6,145 to 30,000 bodies, flat in the crowd because the slowest thread sets the step; a neuron in the crowd at 1e29; then the whole body phase in one kernel, bit-exact in double against the solver over 1.7 billion values with the digest matching, 3.2x to 9.4x over 16 threads in single, and a lost body's NaNs breaking a raw-bit digest across compilations) |
| [0116](0116-the-angle-the-price-the-second-founding.md) | 2026-09-23 | The angle, the price, the second founding (round 46, the base round after the mouth, three seeds, pre-registered: seven rules landing together, light by exposure with the buoyancy offset, the founding trickle with founders that follow their food, the support cost, contact per part, the snow's life at a quarter rate, and the beach, a floor tilted to break the surface with the current faded into it; K1 to K11 read on the clause reader, with the ledger at the round's prices, the round's own screen with its pictures, and the trickle screen before the predictions) |
| [0117](0117-the-reef-and-the-second-chance.md) | 2026-09-23 | The reef and the second chance (round 47, pre-registered: the mushroom reef, three rock columns with opaque caps that shade the water under them and tables that catch the snow, and D117's pool, one trickle founder in ten a copy of an evolved stomach that once lived; L1 to L11, the ledger of the pool's four bodies, the smoke with its pictures from the side, above and under a cap) |
| [0118](0118-the-reef-read-and-the-stomachs-dissected.md) | 2026-09-24 | The reef read, and the stomachs dissected (round 47's verdicts: the rock a wall, the shade read as thinner water under every cap at every sample, the tables gathering snow under a crowd, nothing living in the dark; the pool's 261 stomachs dead in a minute except the three that landed above 1 J/m³, which all bred; the dissection of every stomach born: a transient larder, senescence wearing both sides of the ledger, wasted founders, dispersal exonerated, the mixotroph the form nearest replacement; two clauses drawn wrong and left failed; what round 48 changes) |
| [0119](0119-a-stomach-on-a-plant-and-paying-as-you-go.md) | 2026-09-24 | A stomach on a plant, and paying as you go (round 48, pre-registered: round 47's world with D119 to D122, a cell type only as a bud with the floors weighing rigid groups, reproduction paid as it goes as a gene beside the lump with the overhead twice the child's tissue above a 50 J floor, senescence on upkeep alone, every founder at its food's richest cell with 600 s of its own watts; M1 to P1, the ledger of the pool at the round's prices, the smoke, and two count screens, the first doubling every hundred seconds at a 10 J floor and the second settling at about twice round 47's crowd at 50 J) |
| [0120](0120-the-eaters-spent-their-endowment-on-one-child.md) | 2026-09-25 | The eaters spent their endowment on one child, and a leaf kept a speck of stomach (round 48's read: five clauses hold, three fail, eight censored on seed 2's stop at 13,700 s; every pool eater's line died out, the endowment paid for the one-part stomach's first child at landing, a leaf's stomach bud founded a line of 38, gestation was selected down, and a resume from a round 48 checkpoint is not faithful because the contact sense is not restored) |
| [0108](0108-a-body-earns-its-outline.md) | 2026-09-19 | A body earns its outline (round 41d, round 41c's world with D099's silhouette cap on and the joint free again, pre-registered: 0107's predictions carried, the fold read gone on the contact instrument and the probe, the free joint's founding recorded; stopped at 15,000 s under V5 when the bush grew by another route, the cap binding and the bush still earning 1.7 times a leaf's light on the same matter) |
| [0107](0107-matter-is-matter.md) | 2026-09-18 | Matter is matter (round 41, round 40's world on the one-substance economy of D098 at 3,000 units and a 100 J overhead, pre-registered: the crowd the matter builds, the water it regenerates, the larder it leaves the eaters; rounds 41, 41b and 41c stopped, the last on a knot: a terminal-only self-edge grows a sixteen-part ball that earns sixteen areas of light and costs the physics every pair) |

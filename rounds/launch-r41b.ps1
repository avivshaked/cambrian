...
# ASCII only.
#   ./rounds/launch-r41b.ps1 -Seed 1 -Worker 2 -ExpectSimHash <hash>                        # r41-s1
#   ./rounds/launch-r41b.ps1 -Seed 1 -Worker 2 -Seconds 5000 -Name r41smoke-s1 -Dt 0.02     # the screen
...
$name = if ($Name -ne '') { $Name } else { "r41b-s$Seed" }
$extra = @{}

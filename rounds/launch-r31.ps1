...
#   ./rounds/launch-r31.ps1 -Seed 1 -Worker 2 -ExpectSimHash <hash>                       # r30-s1
#   ./rounds/launch-r31.ps1 -Seed 1 -Worker 7 -Seconds 200 -Name r30smoke -Dt 0.02       # a compile check

...
measured the cost 2026-09-05, [logbook/0064](logbook/0064-the-crowd-costs-nothing.md): none; the constraints are packing and a horizontal boundary rule — **ruled as D077, 2026-09-05 ("proceed"): a literal 4 × 10 × 10 m ring 60 m deep, patches as regions read from position, periodic horizontal wrap, a restoring top and bottom, newborns beside the parent; building from `scratch/footprint-spec.md`; then one screen at 0.02 with the dose and the surface fix folded in, then the 0.01 confirmation**) → predation (on contact; the encounter

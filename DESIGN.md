...
| **[PC95]** | D. Pauly & V. Christensen, "Primary production required to sustain global fisheries," *Nature* 374:255–257, 1995. DOI `10.1038/374255a0` — **read: abstract and Fig. 2 [p.1, p.3]** (review round 5). The 10% rule's provenance: 140 transfer-efficiency estimates, TL2–TL4, mean close to 10%. | `research/papers/61-pauly-christensen-1995-ppr/` |
| **[MCP05]** | E. Marañón, P. Cermeño & V. Pérez, "Continuity in the photosynthetic production of dissolved organic carbon from eutrophic to oligotrophic waters," *Mar. Ecol. Prog. Ser.* 299:7–17, 2005. DOI `10.3354/meps299007` — **read: abstract, results, discussion [p.1, p.7–10]** (round 5). PER 22 ± 2%, flat across a 150-fold productivity range. | `research/papers/62-maranon-2005-doc-continuity/` |
| **[LS13]** | D. C. López-Sandoval, T. Rodríguez-Ramos, P. Cermeño & E. Marañón, "Exudation of organic carbon by marine phytoplankton: dependence on taxon and cell size," *Mar. Ecol. Prog. Ser.* 477:53–60, 2013. DOI `10.3354/meps10174` — **read in full** (round 5). Exudation isometric with cell size and indifferent to growth stage. | `research/papers/63-lopez-sandoval-2013-exudation-cell-size/` |
| **[LS11]** | D. C. López-Sandoval, A. Fernández & E. Marañón, "Dissolved and particulate primary production along a longitudinal gradient in the Mediterranean Sea," *Biogeosciences* 8:815–825, 2011. DOI `10.5194/bg-8-815-2011` — **read: abstract, discussion, conclusions [p.1, p.2, p.7, p.8]** (round 5). PER ~37% in ultraoligotrophic water; bacterial carbon demand 5–14× dissolved primary production. | `research/papers/64-lopez-sandoval-2011-dissolved-primary-production-mediterranean/` |
| **[PWAH07]** | L. R. Pomeroy, P. J. leB. Williams, F. Azam & J. E. Hobbie, "The Microbial Loop," *Oceanography* 20(2):28–33, 2007. DOI `10.5670/oceanog.2007.45` — **read in full** (round 5). Most organic matter available to consumers is respired by bacteria; 1–2% of blue-water primary production reaches fishes. | `research/papers/65-pomeroy-2007-microbial-loop/` |
| **[ED21]** | T. D. Eddy, J. R. Bernhardt, J. L. Blanchard et al., "Energy Flow Through Marine Ecosystems: Confronting Transfer Efficiency," *Trends Ecol. Evol.* 36(1):76–86, 2021. DOI `10.1016/j.tree.2020.09.006` — **read: abstract, ecosystem-scale processes, estimates [AM pp.7, 10, 11, 14, 17]** (round 5; locators are accepted-manuscript PDF pages, not journal pages). Producer→herbivore 13% (11–17%). | `research/papers/66-eddy-2021-transfer-efficiency/` |
| **[CH20]** | T.-Y. Chen, C.-C. Lai, F.-K. Shiah & G.-C. Gong, "Dissolved and Particulate Primary Production and Subsequent Bacterial C Consumption in the Southern East China Sea," *Front. Mar. Sci.* 7:713, 2020. DOI `10.3389/fmars.2020.00713` — **read: abstract, results, discussion [p.1, p.5]** (round 5). PER 40.8 ± 12.2%; carries Nagata 2000's 10–20% world-ocean range. | `research/papers/67-chen-2020-doc-bacterial-consumption-ecs/` |

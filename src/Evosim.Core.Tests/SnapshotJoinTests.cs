        ...
        public void SnapshotIdsJoinLineage()
        {
            ...
            try
            {
                BuildFixture(
                    ...
                    lineageRows: new[]
                    {
                        LineageEvent.Birth(0.0, 1, -1, BirthKind.Floor, 0, 0, false, false, false, 0, 1f, 1f, 0f, 0).ToJson(),
                        LineageEvent.Birth(5.0, 2, -1, BirthKind.Floor, 0, 0, false, false, false, 0, 1f, 1f, 0f, 0).ToJson(),
                        LineageEvent.Death(8.0, 2, DeathCause.Starved).ToJson(),
                        LineageEvent.Birth(10.0, 3, 1, BirthKind.Reproduction, 1, 0, false, false, false, 0, 1f, 1f, 0f, 0).ToJson(),
                    },
